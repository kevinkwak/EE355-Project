...
all: $(OBJECTS)
	$(CXX) $(OBJECTS) -o trojan-book.out 

contact: Contact.o test_contact.o
	$(CXX) Contact.o test_contact.o -o test-contact.out

date: Date.o test_date.o 
	$(CXX) Date.o test_date.o -o test-date.out

person: Date.o Contact.o Person.o  misc.o test_person.o
	$(CXX) Date.o Contact.o Person.o misc.o test_person.o -o test-person.out
